        ...
        <footer className="w-full bg-white border-t pt-16 pb-8">
            <div className="container px-4 md:px-6">
                ...
                <div className="flex justify-center mb-12">
                    <Link href="/">
                        <div className="bg-red-600 text-white px-3 py-1 text-2xl md:text-4xl font-black tracking-tighter italic transform -skew-x-6 inline-block hover:opacity-90 transition-opacity">
                            ninetysix
                            <sup className="text-xs md:text-sm font-normal not-italic ml-1">TM</sup>
                        </div>
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="space-y-4">
                        {/* Logo removed from here as it's now centered at top */}
