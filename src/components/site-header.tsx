                            ...
                            <div className="flex flex-col h-full">
                                ...
                                <div className="flex-1 overflow-auto py-4">
                                    <div className="px-6 space-y-1">
                                        <Link href="/" className="block py-3 text-lg font-medium text-red-600" onClick={() => setMobileMenuOpen(false)}>Home</Link>
                                        ...
                                        <Link href="/products" className="block py-3 text-lg font-bold" onClick={() => setMobileMenuOpen(false)}>All Products</Link>
                                        <Link href="/about" className="block py-3 text-lg font-bold" onClick={() => setMobileMenuOpen(false)}>About Us</Link>

                                        {isAdmin && (
                                            // ... rest of the file
                                            <Link href="/admin" className="block py-3 text-lg font-bold text-primary" onClick={() => setMobileMenuOpen(false)}>
